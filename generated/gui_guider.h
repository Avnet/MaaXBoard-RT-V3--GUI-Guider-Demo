...
typedef struct
{
	...
	lv_obj_t *help_screen_bkgimg;
	lv_obj_t *help_screen_boardimg;
	...
	lv_obj_t *usb_screen;
	lv_obj_t *usb_screen_bkgimg;
	lv_obj_t *usb_screen_rightbtn0;
	lv_obj_t *usb_screen_rightbtn0_label;
	lv_obj_t *usb_screen_rightlabel;
	lv_obj_t *usb_screen_avlogoimg0;
	lv_obj_t *usb_screen_leftbtn0;
	lv_obj_t *usb_screen_leftbtn0_label;
	lv_obj_t *usb_screen_leftlabel;
	lv_obj_t *video_screen;
	lv_obj_t *video_screen_bkgimg;
	lv_obj_t *video_screen_rightbtn0;
	lv_obj_t *video_screen_rightbtn0_label;
	lv_obj_t *video_screen_rightlabel;
	lv_obj_t *video_screen_avlogoimg0;
	lv_obj_t *video_screen_leftbtn0;
	lv_obj_t *video_screen_leftbtn0_label;
	lv_obj_t *video_screen_leftlabel;
	lv_obj_t *system_screen;
	lv_obj_t *system_screen_bkgimg;
	lv_obj_t *system_screen_rightbtn0;
	lv_obj_t *system_screen_rightbtn0_label;
	lv_obj_t *system_screen_rightlabel;
	lv_obj_t *system_screen_avlogoimg0;
	lv_obj_t *system_screen_leftbtn0;
	lv_obj_t *system_screen_leftbtn0_label;
	lv_obj_t *system_screen_leftlabel;
}lv_ui;
