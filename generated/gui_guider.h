...
typedef struct
{
	...
	lv_obj_t *screen3_USB2;
	lv_obj_t *screen3_USB2_canvas_white;
	lv_obj_t *screen3_USB2_left_btn;
	lv_obj_t *screen3_USB2_left_btn_label;
	lv_obj_t *screen3_USB2_left_label;
	lv_obj_t *screen3_USB2_avlogoimg0;
	lv_obj_t *screen3_USB2_right_btn;
	lv_obj_t *screen3_USB2_right_btn_label;
	lv_obj_t *screen3_USB2_right_label;
	lv_obj_t *screen3_USB2_home_btn;
	lv_obj_t *screen3_USB2_home_btn_label;
	lv_obj_t *screen3_USB2_page_label;
	lv_obj_t *screen3_USB2_usb_list;
	lv_obj_t *screen3_USB2_usb_devices_label;
	lv_obj_t *screen3_USB2_input_label;
	lv_obj_t *screen3_USB2_ic2_nodes_label;
	lv_obj_t *screen3_USB2_ic2_table;
	lv_obj_t *screen3_USB2_input_area;
	lv_obj_t *screen3_USB2_kbd_imgbtn;
	lv_obj_t *screen3_USB2_kbd_imgbtn_label;
	lv_obj_t *screen3_USB2_mouse_imgbtn;
	lv_obj_t *screen3_USB2_mouse_imgbtn_label;
