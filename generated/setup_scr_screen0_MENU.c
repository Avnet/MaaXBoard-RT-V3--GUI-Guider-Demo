...
void setup_scr_screen0_MENU(lv_ui *ui){
	...
	lv_obj_set_pos(ui->screen0_MENU_board_img, 148, 200);
	...
	lv_obj_set_pos(ui->screen0_MENU_imgbtn_1, 29, 890);
	lv_obj_set_size(ui->screen0_MENU_imgbtn_1, 300, 106);
	lv_imgbtn_set_src(ui->screen0_MENU_imgbtn_1,LV_BTN_STATE_RELEASED,&_button_alpha_300x106);
	lv_imgbtn_set_src(ui->screen0_MENU_imgbtn_1,LV_BTN_STATE_PRESSED,&_button_on_alpha_300x106);
	...
	lv_obj_set_pos(ui->screen0_MENU_imgbtn_2, 392, 892);
	lv_obj_set_size(ui->screen0_MENU_imgbtn_2, 300, 106);
	lv_imgbtn_set_src(ui->screen0_MENU_imgbtn_2,LV_BTN_STATE_RELEASED,&_button_alpha_300x106);
	lv_imgbtn_set_src(ui->screen0_MENU_imgbtn_2,LV_BTN_STATE_PRESSED,&_button_on_alpha_300x106);
