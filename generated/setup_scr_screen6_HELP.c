...
void setup_scr_screen6_HELP(lv_ui *ui){
	...
	//Write codes screen6_HELP_leftbtn0
	ui->screen6_HELP_leftbtn0 = lv_imgbtn_create(ui->screen6_HELP, NULL);

	//Write style LV_IMGBTN_PART_MAIN for screen6_HELP_leftbtn0
	static lv_style_t style_screen6_HELP_leftbtn0_main;
	lv_style_init(&style_screen6_HELP_leftbtn0_main);

	//Write style state: LV_STATE_DEFAULT for style_screen6_HELP_leftbtn0_main
	lv_style_set_text_color(&style_screen6_HELP_leftbtn0_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_image_recolor(&style_screen6_HELP_leftbtn0_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_image_recolor_opa(&style_screen6_HELP_leftbtn0_main, LV_STATE_DEFAULT, 0);
	lv_style_set_image_opa(&style_screen6_HELP_leftbtn0_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->screen6_HELP_leftbtn0, LV_IMGBTN_PART_MAIN, &style_screen6_HELP_leftbtn0_main);
	lv_obj_set_pos(ui->screen6_HELP_leftbtn0, 3, 3);
	lv_obj_set_size(ui->screen6_HELP_leftbtn0, 150, 150);
	lv_imgbtn_set_src(ui->screen6_HELP_leftbtn0,LV_BTN_STATE_RELEASED,&_left_arrow_alpha_150x150);
	lv_imgbtn_set_src(ui->screen6_HELP_leftbtn0,LV_BTN_STATE_PRESSED,&_left_arrow_dark_alpha_150x150);

	//Write codes screen6_HELP_label_MENU4
	ui->screen6_HELP_label_MENU4 = lv_label_create(ui->screen6_HELP, NULL);
	lv_label_set_text(ui->screen6_HELP_label_MENU4, "MENU");
	lv_label_set_long_mode(ui->screen6_HELP_label_MENU4, LV_LABEL_LONG_BREAK);
	lv_label_set_align(ui->screen6_HELP_label_MENU4, LV_LABEL_ALIGN_CENTER);

	//Write style LV_LABEL_PART_MAIN for screen6_HELP_label_MENU4
	static lv_style_t style_screen6_HELP_label_MENU4_main;
	lv_style_init(&style_screen6_HELP_label_MENU4_main);

	//Write style state: LV_STATE_DEFAULT for style_screen6_HELP_label_MENU4_main
	lv_style_set_radius(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 0);
	lv_style_set_bg_color(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_dir(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, LV_GRAD_DIR_VER);
	lv_style_set_bg_opa(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 255);
	lv_style_set_text_color(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, &lv_font_simsun_48);
	lv_style_set_text_letter_space(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 2);
	lv_style_set_pad_left(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_right(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_top(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_bottom(&style_screen6_HELP_label_MENU4_main, LV_STATE_DEFAULT, 0);
	lv_obj_add_style(ui->screen6_HELP_label_MENU4, LV_LABEL_PART_MAIN, &style_screen6_HELP_label_MENU4_main);
	lv_obj_set_pos(ui->screen6_HELP_label_MENU4, 8, 143);
	lv_obj_set_size(ui->screen6_HELP_label_MENU4, 130, 0);
