...
static void welcome_screen_redbtn0event_handler(lv_obj_t * obj, lv_event_t event)
{
	...
	{
		lv_obj_set_style_local_text_font(guider_ui.welcome_screen_redlabel0, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_simsun_28);
...
static void welcome_screen_greenbtn0event_handler(lv_obj_t * obj, lv_event_t event)
{
	...
	case LV_EVENT_PRESSED:
	{
		lv_obj_set_style_local_text_font(guider_ui.welcome_screen_greenlabel0, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_simsun_28);
...
static void welcome_screen_bluebtn0event_handler(lv_obj_t * obj, lv_event_t event)
{
	...
	case LV_EVENT_PRESSED:
	{
		lv_obj_set_style_local_text_font(guider_ui.welcome_screen_bluelabel0, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, &lv_font_simsun_28);
