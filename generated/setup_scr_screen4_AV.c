...
void setup_scr_screen4_AV(lv_ui *ui){
	...
	lv_style_set_text_color(&style_screen4_AV_camera_label_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	...
	lv_label_set_text(ui->screen4_AV_mic_label, "Microphone State:");
	...
	lv_obj_set_pos(ui->screen4_AV_mic_label, 30, 320);
	...
	lv_style_set_text_color(&style_screen4_AV_camera_state_label_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	...
	//Write codes screen4_AV_mic_state_label
	ui->screen4_AV_mic_state_label = lv_label_create(ui->screen4_AV, NULL);
	lv_label_set_text(ui->screen4_AV_mic_state_label, "Not Enabled");
	lv_label_set_long_mode(ui->screen4_AV_mic_state_label, LV_LABEL_LONG_BREAK);
	lv_label_set_align(ui->screen4_AV_mic_state_label, LV_LABEL_ALIGN_LEFT);

	//Write style LV_LABEL_PART_MAIN for screen4_AV_mic_state_label
	static lv_style_t style_screen4_AV_mic_state_label_main;
	lv_style_init(&style_screen4_AV_mic_state_label_main);

	//Write style state: LV_STATE_DEFAULT for style_screen4_AV_mic_state_label_main
	lv_style_set_radius(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 0);
	lv_style_set_bg_color(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_color(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_bg_grad_dir(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, LV_GRAD_DIR_VER);
	lv_style_set_bg_opa(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 255);
	lv_style_set_text_color(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, &lv_font_OpenSans_SemiBold_40);
	lv_style_set_text_letter_space(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 2);
	lv_style_set_pad_left(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_right(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_top(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 0);
	lv_style_set_pad_bottom(&style_screen4_AV_mic_state_label_main, LV_STATE_DEFAULT, 0);
	lv_obj_add_style(ui->screen4_AV_mic_state_label, LV_LABEL_PART_MAIN, &style_screen4_AV_mic_state_label_main);
	lv_obj_set_pos(ui->screen4_AV_mic_state_label, 30, 375);
	lv_obj_set_size(ui->screen4_AV_mic_state_label, 600, 0);
	...
	lv_style_set_text_color(&style_screen4_AV_audio_test_imgbtn_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
